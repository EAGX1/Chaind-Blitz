...
function deck40(parts, fill = "scroll_greed") {
  ...
  if (ids.length > 40) ids.length = 40;
  return ids;
}
...
export const LOANER_DECKS = {
  ...
  contact_combo: {
    ...
    deck: deck40([
      ...
      ["jestling", "surge_imp"],
      x("gy_fusion_rite", 2), x("call_fallen", 2), x("ember_spark", 2),
      x("null_seal", 2), x("burning_lance", 2), ["flame_banner"]
    ]),
    extra: ["fusion_ember_drake"]
  },
  control_counters: {
  ...
  big_evolve: {
    ...
    deck: deck40([
      ...
      x("stoneback", 3), x("grove_elder", 2), x("nimbus_knight", 2),
      x("seed_sage", 2), x("shield_sprite", 2), x("void_pilgrim", 2),
      ["world_turtle"],
      x("overgrowth", 2), x("stone_skin", 2), x("wild_call", 2),
      x("null_seal", 2), x("verdant_rebuke", 2), x("root_snare", 2),
      x("pyre_colossus", 2), x("lane_breaker", 2), ["final_edict"]
    ], "overgrowth"),
    extra: ["fusion_terra_crown"]
  },
  fusion_ladder: {
    ...
    deck: deck40([
      x("ember_fox", 3), x("cinder_knight", 3), x("fusion_polymer", 2),
      x("moss_sprite", 3), x("grove_elder", 2), x("swift_falcon", 2),
      x("doomblade_novice", 2), x("dawn_pixie", 2), x("scav_wisp", 2),
      ["jestling", "seed_sage"],
      x("gy_fusion_rite", 2), x("call_fallen", 2), x("wild_call", 2),
      x("null_seal", 2), x("overgrowth", 2), ["ember_spark"]
    ]),
    extra: ["fusion_ember_drake"]
  },
  hybrid_abyss_tempo: {
  ...
  wide_rush: {
    ...
    deck: deck40([
      ...
      x("nimbus_knight", 2), x("doomblade_novice", 2), ["surge_imp", "jestling"],
      x("silver_going_second", 2), x("ember_spark", 3), x("fever_pitch", 2),
      x("burning_lance", 2), x("lane_breaker", 2), x("null_seal", 2)
    ]),
    extra: ["fusion_ember_drake", "fusion_choice_blade"]
  },
  spell_tempo: {
  ...
  discard_payoff: {
    ...
    deck: deck40([
      x("silver_discard_wraith", 3), x("scav_wisp", 3), x("jestling", 3),
      x("mawling", 2), x("drain_leech", 2), x("grinning_echo", 2),
      x("tide_priestess", 2), x("void_pilgrim", 2), x("oracle_eel", 2),
      x("lane_breaker", 2), x("edict_squire", 2), x("mill_spore", 2),
      x("call_fallen", 3), x("moonwell", 2), x("riptide", 2),
      x("null_seal", 2), x("silencing_depths", 2), x("mind_surge", 2)
    ], "call_fallen"),
    extra: ["fusion_abyss_leviathan"]
  },
  lane_surfer: {
  ...
  heal_stall: {
    ...
    deck: deck40([
      x("silver_stall_shell", 3), x("heal_bloom", 3), x("ward_sentinel", 3),
      x("stoneback", 3), x("shield_sprite", 2), x("world_turtle", 2),
      x("moss_sprite", 2), x("dawn_pixie", 2), ["grove_elder"],
      x("moonwell", 2), x("stone_skin", 2), x("overgrowth", 2),
      x("verdant_rebuke", 2), x("null_seal", 2), x("root_snare", 2),
      x("bastion_oak", 2), ["final_edict"]
    ], "moonwell"),
    extra: ["fusion_choice_shield"]
  },
  drain_walls: {
    ...
    deck: deck40([
      ...
      x("ward_sentinel", 2), x("tide_caller", 2), x("frost_mage", 2),
      x("shield_sprite", 2), x("stoneback", 2), x("heal_bloom", 2),
      x("tide_cutter", 2), ["depths_lurker"],
      x("moonwell", 2), x("tidal_snare", 2),
  ...
  chain_lock: {
    ...
    deck: deck40([
      ...
      x("tide_priestess", 2), x("scav_wisp", 2), ["chrono_mite"],
  ...
  choice_recipe: {
    ...
    deck: deck40([
      x("silver_choice_agent", 2), x("fusion_polymer", 2), x("ember_fox", 3),
      x("cinder_knight", 3), x("scav_wisp", 2), x("moss_sprite", 2),
      x("doomblade_novice", 2), x("swift_falcon", 2), x("dawn_pixie", 2),
      x("lane_breaker", 2), x("spark_raider", 2), ["jestling"],
      x("gy_fusion_rite", 2), x("call_fallen", 2), x("wild_call", 2),
      x("null_seal", 2), x("ember_spark", 2), ["overgrowth"]
    ]),
    extra: ["fusion_ember_drake", "fusion_choice_blade"]
  },
  substitute_toolbox: {
    ...
    deck: deck40([
      x("fusion_polymer", 1), x("silver_choice_agent", 2), x("ember_fox", 3),
      x("cinder_knight", 2), x("moss_sprite", 2), x("scav_wisp", 3),
      x("void_pilgrim", 2), x("doomblade_novice", 2), x("grove_elder", 2),
      ["seed_sage"],
      x("gy_fusion_rite", 2), x("call_fallen", 2), x("null_seal", 2),
      x("wild_call", 2), x("overgrowth", 2), ["ember_spark"]
    ]),
    extra: ["fusion_ember_drake"]
  },
  comeback_toolbox: {
  ...
  ramp_into_boss: {
    ...
    deck: deck40([
      x("silver_ramp_seed", 3), x("seed_sage", 2), x("moss_sprite", 3),
      x("heal_bloom", 2), x("grove_elder", 2), x("evolve_colossus", 2),
      x("world_turtle", 2), x("wolf_alpha", 2), x("dawn_pixie", 2),
      x("thorn_archer", 2), x("stoneback", 2), ["inferno_titan"],
      x("overgrowth", 2), x("wild_call", 2), x("moonwell", 2),
      x("stone_skin", 2), x("null_seal", 2), x("verdant_rebuke", 2),
      ["root_snare"]
    ], "overgrowth"),
    extra: []
  },
  ...
  handtrap_midrange: {
    ...
    deck: deck40([
      ...
      x("doomblade_novice", 2), x("rush_swarmling", 3), x("spark_raider", 2),
  ...
  lifegain_midrange: {
    ...
    deck: deck40([
      x("silver_lifegain_mid", 3), x("heal_bloom", 3), x("moss_sprite", 3),
      x("thorn_archer", 2), x("ward_sentinel", 2), x("seed_sage", 2),
      x("grove_elder", 2), x("dawn_pixie", 2), x("shield_sprite", 2),
      ["wolf_alpha"],
      x("moonwell", 3), x("overgrowth", 2), x("wild_call", 2),
  ...
  value_midrange: {
    ...
    deck: deck40([
      ...
      x("thorn_archer", 2), x("scav_wisp", 2), x("void_pilgrim", 2),
      x("nimbus_knight", 2), x("doomblade_novice", 2), x("tide_caller", 2),
      x("grove_elder", 2), ["ember_fox"],
      x("lane_breaker", 2), x("call_fallen", 2), x("null_seal", 2),
      x("ember_spark", 2), x("root_snare", 2), x("moonwell", 2),
      ["verdant_rebuke", "tidal_snare"]
    ]),
  ...
  tri_splash: {
    ...
    deck: deck40([
      ...
      x("null_seal", 2), x("root_snare", 2), x("tri_envoy", 2),
      x("lane_breaker", 2), ["fever_pitch", "verdant_rebuke", "riptide"]
    ]),
      extra: ["fusion_ember_drake"]
  },
  ambush_trapdoor: {
  ...
  gy_fusion_combo: {
    ...
    deck: deck40([
      x("silver_gy_fusion", 3), x("fusion_polymer", 2), x("scav_wisp", 3),
      x("jestling", 3), x("ember_fox", 3), x("mawling", 2),
      x("cinder_knight", 2), x("grinning_echo", 2), x("void_pilgrim", 2),
      x("mill_spore", 2), x("lane_breaker", 2),
      ["doomblade_novice"],
      x("gy_fusion_rite", 2), x("call_fallen", 3), x("null_seal", 2),
      x("riptide", 2), x("ember_spark", 2), ["moonwell"]
    ], "call_fallen"),
    extra: ["fusion_ember_drake"]
  },
  ignis_mid: {
    ...
    deck: deck40([
      ...
      x("rush_swarmling", 3), x("doomblade_novice", 2), ["pyro_hydra"],
  ...
  abyss_tempo: {
    ...
    deck: deck40([
      x("tide_caller", 3), x("frost_mage", 3), x("silver_bounce_tide", 2),
      x("depths_lurker", 2), x("tide_priestess", 2), x("ambush_stalker", 2),
      x("drain_leech", 2), x("abyss_warden", 2), x("oracle_eel", 2),
      ["deep_serpent"],
      x("tidal_snare", 2), x("riptide", 2), x("ash_whisper", 2),
      x("null_seal", 2), x("tide_cutter", 2), x("veil_negate", 2),
      ["deep_freeze", "judgment_chain"]
    ], "moonwell"),
    extra: ["fusion_abyss_leviathan"]
  },
  terra_beat: {
    ...
    deck: deck40([
      x("moss_sprite", 3), x("thorn_archer", 2), x("wolf_alpha", 1),
      x("seed_sage", 2), x("grove_elder", 1), x("dawn_pixie", 2),
      x("stoneback", 2), x("silver_lifegain_mid", 2), x("heal_bloom", 2),
      x("gem_golem", 2), ["nimbus_knight"],
      x("overgrowth", 1), x("wild_call", 1), x("root_snare", 2),
      x("verdant_rebuke", 1), x("null_seal", 2), x("stone_skin", 2),
  ...
  jest_engine: {
    ...
    deck: deck40([
      x("jestling", 3), x("scav_wisp", 3), x("grinning_echo", 3),
      x("mawling", 2), x("surge_imp", 2), x("chrono_mite", 2),
      x("void_pilgrim", 2), x("doomblade_novice", 2), x("oracle_eel", 2),
      x("mill_spore", 2), ["tide_priestess"],
      x("call_fallen", 3), x("lane_breaker", 2), x("mind_surge", 2),
...
/** Weaker archetypes get easier, bigger Extra bosses; stronger lists stay thin. */
const ignisBest = ["fusion_pyre_wyrm", "fusion_ember_drake", "fusion_tempo_ace", "fusion_ash_seraph"];
const ignisMid = ["fusion_ember_drake", "fusion_tempo_ace", "fusion_ash_seraph"];
const ignisThin = ["fusion_ember_drake"];
...
const abyssThin = ["fusion_abyss_leviathan"];
...
const terraThin = ["fusion_grove_knight"];
const gyBest = ["fusion_grave_tyrant", "fusion_abyss_leviathan", "fusion_ember_drake"];
const gyMid = ["fusion_grave_tyrant", "fusion_abyss_leviathan"];
const fusionBest = [
  "fusion_ember_drake", "fusion_terra_crown", "fusion_choice_blade"
];
const fusionMid = ["fusion_ember_drake", "fusion_choice_blade", "fusion_choice_shield"];
