...
export const ALL_CARDS = [
  ...BRONZE_CARDS, ...WAVE_C_CARDS, ...WAVE_D_CARDS, ...WAVE_E_CARDS, ...WAVE_F_CARDS, ...WAVE_G_CARDS, ...SILVER_CARDS,
  ...GOLD_CARDS, ...PLATINUM_CARDS, ...EXTRA_CARDS
];
export const CARD_DB = {
  ...BRONZE_DB, ...WAVE_C_DB, ...WAVE_D_DB, ...WAVE_E_DB, ...WAVE_F_DB, ...WAVE_G_DB, ...SILVER_DB,
  ...GOLD_DB, ...PLATINUM_DB, ...EXTRA_DB
};
