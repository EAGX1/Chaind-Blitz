...
describe("pool gating", () => {
  ...
  it("ranked pools ramp until Diamond equals the full unique catalog; Master is prestige", () => {
    const expected = [
      ...
      uniqueIds(BRONZE_CARDS, WAVE_C_CARDS, SILVER_CARDS, WAVE_G_CARDS, WAVE_H_CARDS, GENERIC_STAPLES),
      uniqueIds(BRONZE_CARDS, WAVE_C_CARDS, SILVER_CARDS, WAVE_G_CARDS, WAVE_H_CARDS, GENERIC_STAPLES, WAVE_D_CARDS, GOLD_CARDS),
      uniqueIds(BRONZE_CARDS, WAVE_C_CARDS, SILVER_CARDS, WAVE_G_CARDS, WAVE_H_CARDS, GENERIC_STAPLES, WAVE_D_CARDS, GOLD_CARDS, WAVE_E_CARDS, EXTRA_CARDS, PLATINUM_CARDS),
      uniqueIds(BRONZE_CARDS, WAVE_C_CARDS, SILVER_CARDS, WAVE_G_CARDS, WAVE_H_CARDS, GENERIC_STAPLES, WAVE_D_CARDS, GOLD_CARDS, WAVE_E_CARDS, EXTRA_CARDS, PLATINUM_CARDS, WAVE_F_CARDS),
      uniqueIds(BRONZE_CARDS, WAVE_C_CARDS, SILVER_CARDS, WAVE_G_CARDS, WAVE_H_CARDS, GENERIC_STAPLES, WAVE_D_CARDS, GOLD_CARDS, WAVE_E_CARDS, EXTRA_CARDS, PLATINUM_CARDS, WAVE_F_CARDS),
    ];
